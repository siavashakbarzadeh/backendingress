...
//slider
Route::get('sliders-show', [\App\Http\Controllers\admin\SliderController::class, 'show'])->name('sliders-show');
Route::get('sliders-create', [\App\Http\Controllers\admin\SliderController::class, 'create'])->name('sliders-create');
Route::post('sliders-store', [\App\Http\Controllers\admin\SliderController::class, 'store'])->name('sliders-store');
Route::get('shippings-edit/{id}', [ShippingController::class, 'edit'])->name('shippings-edit');
Route::get('shippings-update/{id}', [ShippingController::class, 'update'])->name('shippings-update');
Route::get('shippings-destroy/{id}', [ShippingController::class, 'destroy'])->name('shippings-destroy');
//endslider
...
//    Route::get('orders-show', [ApiOrderController::class, 'show'])->name('orders-show');
//    Route::get('nfts-show', [ApiNftController::class, 'show'])->name('nfts-show');
